...
#show: cv.with(
  ...
  profile-picture: image("../assets/avatar.jpg"),
...
#side[
  ...
  = Certifications
  - #link("https://drive.google.com/file/d/11DS5v-27Jbta6EgColGSrX1gGo3kzcf9/view?usp=sharing")[IELTS Academic (2023)]
  - #link("https://bigocoder.com/certificates/1754")[Competitive Programming (2024)]
  - #link("https://coursera.org/share/b2b177768e85b32b6938afd7fd33101d")[Machine Learning (2022)]
]
...
#entry(
  title: link("https://drive.google.com/file/d/1NE7Rw5QA0JfCkwQuSxeUcJ4Y0bXO_BPS/view?usp=drive_link")[Bachelor's Degree],
  date: "2019 - 2023",
  institution: "Ho Chi Minh City University of Science",
  location: "Ho Chi Minh City, Vietnam",
)[
  - Field: Computer Science
  - GPA: #link("https://drive.google.com/file/d/1u6QB9Lk82uT9-B4Y_wsg2JmV1AjqahVZ/view?usp=drive_link")[8.34]/10
]
...
= Projects
...
#entry(
  title: link("https://github.com/ghibli613/Scene-Graph-Benchmark")[Scene graph generation for image understanding],
  date: "2025",
  institution: "Ho Chi Minh City University of Science",
  location: "Ho Chi Minh City, Vietnam",
)[
  ...
  - Diagnosed and fixed codebase issues while integrating updated dependencies for newer deep learning stacks, improving long-term maintainability and reducing setup friction for subsequent research iterations.
]

#entry(
  title: link("https://github.com/Halsey77/usggen")[Graph generation for anomalous detection],
  date: "2025",
  institution: "Ho Chi Minh City University of Science",
  location: "Ho Chi Minh City, Vietnam",
)[
  ...
  - Performed error analysis on baseline results and proposed concrete improvement directions, including targeted data augmentation strategies, transfer learning from related tasks, and structured hyperparameter optimization to improve detection robustness.
]
...
#[
  ...
  - *Languages:* Python, C++, CUDA C/C++, Ruby
  - *Frameworks:* PyTorch, TensorFlow, Keras, Scikit-learn
  - *Data Systems:* Chroma, MongoDB, SQL Server
  - *Visual Representation Learning:* ViT, GANs, Scene Graph Generation, Anomaly Detection
  - *Image Processing:* Morphological Operations, Seam Carving
  - *Libraries & Tools:* OpenCV, NumPy, Pandas, Docker, FastAPI
]
